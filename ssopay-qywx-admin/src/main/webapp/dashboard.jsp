                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div id="ribbon">
                                ...
                                <ol class="breadcrumb pull-right">
                                                                        <li><a href="javascript:;" data-url="/admin/dashboard">控制台</a></li>
                                                                    </ol>
                            </div>
                            <!-- END RIBBON -->
                                                        <div class="content">
...
<script>
    var Orderdata = {
    column: ["2017-07-03","2017-07-04","2017-07-05","2017-07-06","2017-07-07","2017-07-08","2017-07-09"],
            paydata: [36,15,21,76,53,25,21],
            createdata: [154,86,124,149,178,173,53],
    };
</script>
                            </div>
                        </div>
